...
public class CodeGenerator {
    ...
    private static final String JDBC_URL = "jdbc:mysql://localhost/bank?useUnicode=true&useSSL=false&characterEncoding=utf8";
    private static final String JDBC_USER_NAME = "root";
    private static final String JDBC_PASSOWRD = "lxx0401.";

    // 包名和模块名
    private static final String PACKAGE_NAME = "com.bank";
    private static final String MODULE_NAME = "bank";

    // 表名，多个表使用英文逗号分割
    private static final String TBL_NAMES = "client_product,loan_record,finance_product,water_log";
